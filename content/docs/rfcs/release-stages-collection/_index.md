---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/release-stages-collection - changes to this file will be overwritten!
hide_summary: true
title: Move collections to management-cluster-bases, introduce shared collection and support stages
toc_hide: true
---

| Created | State | Summary |
|-|-|-|
| 2025-11-11 | <span style="color: darkgreen; font-weight: bold">approved</span> | Move collections to management-cluster-bases, introduce shared-collection and support stages. |
