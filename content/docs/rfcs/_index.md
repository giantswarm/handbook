...
| ---------------------- | ----- | ----- |
| 2025-02-25 | <span>[Title](./giantswarm-platform-labels)</span><br><br><span style="opacity: 0.7">This RFC proposes a new label to identify pods by their platform subsystem, aiming to simplify operations and maintenance. The label will use free-form text values, with a documented list of common values. Implementation includes adding the label to a repository and documentation.</span> | <span style="color: darkorange">review</span> |
