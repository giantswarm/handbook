---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/alias-forwarder-email-service - changes to this file will be overwritten!
hide_summary: true
...
|-|-|-|
| 2022-02-15 | <span style="color: darkgray; opacity: 0.8">obsolete</span> | Add alias `support+customer@giantswarm.io` to forward e-mail to customer's Slack channel. Also add alias `urgent+area@giantswarm.io` to forward to the area in Opsgenie. This change was introduced, but later reverted, so this RFC is obsolete. |
