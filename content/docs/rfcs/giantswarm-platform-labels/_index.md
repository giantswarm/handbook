---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/giantswarm-platform-labels - changes to this file will be overwritten!
hide_summary: true
title: Title
toc_hide: true
---
...
|-|-|-|
| 2025-02-25 | <span style="color: darkorange">review</span> | This RFC proposes a new label to identify pods by their platform subsystem, aiming to simplify operations and maintenance. The label will use free-form text values, with a documented list of common values. Implementation includes adding the label to a repository and documentation. |
