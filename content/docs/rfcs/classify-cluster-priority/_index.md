---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/classify-cluster-priority - changes to this file will be overwritten!
hide_summary: true
...
|-|-|-|
| 2022-05-11 | <span style="color: darkgreen; font-weight: bold">approved</span> | Use label `giantswarm.io/service-priority={highest,medium,lowest}` on `Cluster` objects to specify the importance of a customer cluster. |
