---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/teleport-upgrade-testing - changes to this file will be overwritten!
hide_summary: true
title: Teleport Cluster Version Upgrade Testing Pipeline
toc_hide: true
---

| Created | State | Summary |
|-|-|-|
| 2026-01-21 | <span style="color: darkorange">review</span> | Establish an automated testing pipeline to validate Teleport cluster version upgrades before applying to production. Deploy an ephemeral Teleport cluster with the current production version, connect ephemeral MCs, validate connectivity, upgrade to the target version, and re-validate. |
