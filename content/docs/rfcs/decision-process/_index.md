---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/decision-process - changes to this file will be overwritten!
hide_summary: true
title: RFC and decision making process
toc_hide: true
---

| Created | State | Summary |
|-|-|-|
| 2023-10-10 | <span style="color: darkgreen; font-weight: bold">approved</span> | This contains the explicit procedure to follow for creating an RFC and having it reviewed. Introduce a structured YAML header for the Markdown file. List of RFCs gets rendered in the handbook. |
