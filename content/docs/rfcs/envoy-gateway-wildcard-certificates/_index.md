---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/envoy-gateway-wildcard-certificates - changes to this file will be overwritten!
hide_summary: true
title: Wildcard TLS Certificates for Envoy Gateway on Management Clusters
toc_hide: true
---

| Created | State | Summary |
|-|-|-|
| 2026-01-30 | <span style="color: darkgreen; font-weight: bold">approved</span> | Use wildcard TLS certificates on management clusters with Envoy Gateway to eliminate per-service domain configuration in gateway-api-config. |
