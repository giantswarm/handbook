---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/platform-docs-migration - changes to this file will be overwritten!
hide_summary: true
title: Revamp our docs
toc_hide: true
---

| Created | State | Summary |
|-|-|-|
| 2024-02-19 | <span style="color: darkgreen; font-weight: bold">approved</span> | Revamp our docs to describe the Dev Platform product, considering the new Cluster API (CAPI) architecture. Temporarily move vintage to a subpath and create the new content in the top level. The docs entry point can still point to the old till renovation is over. |
