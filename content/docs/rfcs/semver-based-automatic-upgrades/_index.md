---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/semver-based-automatic-upgrades - changes to this file will be overwritten!
hide_summary: true
title: Using semVer tags for automatic app upgrades in different release stages
toc_hide: true
---

| Created | State | Summary |
|-|-|-|
| 2025-12-11 | <span style="color: darkgreen; font-weight: bold">approved</span> | We want to use flux and flux-operator's automatic upgrades capabilities to create automatic upgrades for different release stages, so we don't have to manually or through extra automation care about those rollouts. |
