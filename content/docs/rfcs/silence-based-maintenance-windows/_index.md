---
# DO NOT EDIT! Auto-generated by `handbook/scripts/aggregate-rfcs.py` from https://github.com/giantswarm/rfc/tree/main/silence-based-maintenance-windows - changes to this file will be overwritten!
hide_summary: true
title: Silence-based maintenance windows
toc_hide: true
---

| Created | State | Summary |
|-|-|-|
| 2026-04-28 | <span style="color: darkorange">review</span> | Use temporary Alertmanager silences and the existing Alerts Timeline dashboard instead of building alert routing to PagerDuty during maintenance operations like cluster upgrades. |
