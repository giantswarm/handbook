...
simpler and also means we can retire the [Release](https://docs.giantswarm.io/reference/platform-api/crd/releases.release.giantswarm.io/) CRD used in vintage clusters. Hence, a `default-apps-PROVIDER` app bundle will
